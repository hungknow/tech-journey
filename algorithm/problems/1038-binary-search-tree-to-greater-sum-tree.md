...
This is the same as problem 0538. We need to add the **sum of all greater values** to each node. Since it's a BST, we can use reverse inorder (right → root → left) to accumulate the sum.
