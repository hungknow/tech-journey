...
| # | Title | Solution | Time | Space | Difficulty | Tag | Note |
|-----|----------------|---------------|---------------|---------------|-------------|--------------|-----|
| 0211 | [Add and Search Word - Data structure design](./problems/0211-add-and-search-word-data-structure-design.md) | [Go](./golang/0211_add_and_search_word_data_structure_design.go) | _O(min(n, h))_ | _O(min(n, h))_ | Medium || Trie, DFS
...
| # | Title | Solution | Time | Space | Difficulty | Tag | Note |
|-----|----------------|---------------|---------------|---------------|-------------|--------------|-----|
| 0208 | [Implement Trie (Prefix Tree)](./problems/0208-implement-trie-prefix-tree.md) | [Go](./golang/0208_implement_trie_prefix_tree.go) | _O(n)_ | _O(1)_ | Medium || Trie
...
| 0307 | [Range Sum Query - Mutable](./problems/0307-range-sum-query-mutable.md) | [Go](./golang/0307_range_sum_query_mutable.go) | ctor: _O(n)_, update: _O(logn)_, query:  _O(logn)_ | _O(n)_ | Medium | LintCode | DFS, Segment Tree, BIT, Fenwick Tree
| 0308 | [Range Sum Query 2D - Mutable](./problems/0308-range-sum-query-2d-mutable.md) | [Go](./golang/0308_range_sum_query_2d_mutable.go) | ctor: _O(m * n)_, update: _O(logm * logn)_, query:  _O(logm * logn)_ | _O(m * n)_ | Hard | 🔒 | DFS, Quad Tree, 2D BIT, 2D Fenwick Tree
| 0430 | [Flatten a Multilevel Doubly Linked List](./problems/0430-flatten-a-multilevel-doubly-linked-list.md) | [Go](./golang/0430_flatten_a_multilevel_doubly_linked_list.go)| _O(n)_ | _O(1)_ | Medium | | |
...
| 0525 | [Contiguous Array](./problems/0525-contiguous-array.md) |[Go](./golang/0525_contiguous_array.go) | _O(n)_ | _O(n)_ | Medium         | |
| 0529 | [Minesweeper](./problems/0529-minesweeper.md) | [Go](./golang/0529_minesweeper.go) | _O(m * n)_ | _O(m + n)_ | Medium    || 
...
| 0548 | [Split Array with Equal Sum](./problems/0548-split-array-with-equal-sum.md) | [Go](./golang/0548_split_array_with_equal_sum.go) | _O(n^2)_ | _O(n)_ | Medium    |🔒|
...
| 0559 | [Max Consecutive Ones](./problems/0559-maximum-depth-of-n-ary-tree.md) | [Go](./golang/0559_maximum_depth_of_n_ary_tree.go) | _O(n)_       | _O(h)_          | Easy         | | Tree, DFS |
| 0572 | [Subtree of Another Tree](./problems/0572-construct-string-from-binary-tree.md) | [Go](./golang/0572_construct_string_from_binary_tree.go)| _O(m * n)_ | _O(h)_ | Easy | | |
...
| 0663 | [Equal Tree Partition](./problems/0663-strange-printer.md) | [Go](./golang/0663_strange_printer.go) | _O(n)_ | _O(n)_ | Medium | 🔒 | Hash
| 0677 | [Map Sum Pairs](./problems/0677-map-sum-pairs.md) | [Go](./golang/0677_map_sum_pairs.go) | _O(n)_ | _O(t)_ | Medium || Trie
| 0684 | [Redundant Connection](./problems/0684-redundant-connection.md) | [Go](./golang/0684_redundant_connection.go) | _O(n)_ | _O(n)_ | Medium || Union Find
| 0685 | [Redundant Connection II](./problems/0685-redundant-connection-ii.md) | [Go](./golang/0685_redundant_connection_ii.go) | _O(n)_ | _O(n)_ | Hard || Union Find
...
| 0699 | [Falling Squares](./problems/0699-falling-squares.md) | [Go](./golang/0699_falling_squares.go) | _O(nlogn)_ | _O(n)_ | Hard || Segment Tree |
...
| 0850 | [Rectangle Area II](./problems/0850-rectangle-area-ii.md) | [Go](./golang/0850_rectangle_area_ii.go) | _O(nlogn)_ | _O(n)_ | Hard || Segment Tree |
...
| 1032 | [Stream of Characters](./problems/1032-stream-of-characters.md) | [Go](./golang/1032_stream_of_characters.go) | ctor: _O(n)_ <br> query: _O(m)_ | _O(t)_ | Hard || `Aho-Corasick Automata`, Trie |
| 1065 | [Index Pairs of a String](./problems/1065-index-pairs-of-a-string.md) | [Go](./golang/1065_index_pairs_of_a_string.go) | _O(n + m + z)_ | _O(t)_ | Easy |🔒| `Aho-Corasick Automata`, Trie |
...
| 1409 | [Queries on a Permutation With Key](./problems/1409-queries-on-a-permutation-with-key.md) | [Go](./golang/1409_queries_on_a_permutation_with_key.go) | _O(nlogn)_ | _O(n)_ | Medium | | BIT, Fenwick Tree
...
| 1505 | [Minimum Possible Integer After at Most K Adjacent Swaps On Digits](./problems/1505-minimum-possible-integer-after-at-most-k-adjacent-swaps-on-digits.md) | [Go](./golang/1505_minimum_possible_integer_after_at_most_k_adjacent_swaps_on_digits.go) | _O(nlogn)_ | _O(n)_ | Hard | | BIT, Fenwick Tree
...
| 1649 | [Create Sorted Array through Instructions](./problems/1649-create-sorted-array-through-instructions.md) | [Go](./golang/1649_create_sorted_array_through_instructions.go)| _O(nlogn)_ | _O(n)_ | Hard | variant of [Count of Smaller Numbers After Self](https://leetcode.com/problems/count-of-smaller-numbers-after-self/) | BIT, Fenwick Tree, Merge Sort |
...
| 1834 | [Single-Threaded CPU](./problems/1834-single-threaded-cpu.md) | [Go](./golang/1834_single_threaded_cpu.go) | _O(nlogn)_| _O(n)_| Medium           | | | 
| 1938 | [Maximum Genetic Difference Query](./problems/1938-maximum-genetic-difference-query.md) | [Go](./golang/1938_maximum_genetic_difference_query.go) | _O(nlogk + mlogk)_ | _O(n + logk)_ | Hard | variant of [Maximum XOR With an Element From Array](https://leetcode.com/problems/maximum-xor-with-an-element-from-array/) | DFS, Greedy, Trie
...
| 2179 | [Count Good Triplets in an Array](./problems/2179-count-good-triplets-in-an-array.md) | [Go](./golang/2179_count_good_triplets_in_an_array.go)| _O(nlogn)_ | _O(n)_ | Hard | variant of [Create Sorted Array through Instructions](https://leetcode.com/problems/create-sorted-array-through-instructions/) | BIT, Fenwick Tree |
...
| 2421 | [Number of Good Paths](./problems/2421-number-of-good-paths.md) | [Go](./golang/2421_number_of_good_paths.go)| _O(nlogn)_ | _O(n)_ | Hard | | Sort, Union Find |
