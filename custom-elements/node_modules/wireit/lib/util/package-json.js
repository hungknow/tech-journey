...
export class PackageJson {
     ...
     */
    _analyzeScriptsSection(failures) {
        const scriptsSectionResult = findNamedNodeAtLocation(this._fileAstNode, ['scripts'], this.jsonFile);
     ...
     */
    _analyzeWireitSection(failures) {
        const wireitSectionResult = findNamedNodeAtLocation(this._fileAstNode, ['wireit'], this.jsonFile);
