...
export class IdeAnalyzer {
    ...
    async getCodeActions(path, range) {
        ...
        const scriptInfo = await this._getInfoAboutLocation(packageJson, ourRange.offset);
    ...
    async getDefinition(path, position) {
        ...
        const scriptInfo = await this._getInfoAboutLocation(packageJson, ourPosition);
        if (scriptInfo?.kind === 'dependency') {
    ...
    async _getInfoAboutLocation(packageJson, offset) {
