...
class TicTacToe:
    def __init__(self):
        ...
        self.status, = page["h2#status"]
        self.console, = page["script#console"]
        self.output, = page["div#terminal"]
        self.init_cells()
    ...
    def check_winner(self):
        ...
        for combo in self.winning_combos:
            ...
            if winner:
                ...
                for i, j in combo:
                    self.cells[i][j].classList.add("win")
                return winner
